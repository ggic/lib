...
public class TestProducer {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            while (true) {
                String speaker = "speaker-"+new Random().nextDouble();
                String text ="你好_" + new Random().nextInt();
                producer.send(new ProducerRecord<String, String>("chat", speaker,text));
                System.out.println(speaker+"说："+text);
