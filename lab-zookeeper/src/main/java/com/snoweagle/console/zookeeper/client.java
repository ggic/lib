package com.snoweagle.console.zookeeper;
...
//
//        // 取出子目录节点列表
        System.out.println(zk.getChildren("/dubbo/com.snoweagle.lab.duboo.server.DemoService", false));
//
//        // 创建另外一个子目录节点
...
//        System.out.println(zk.getChildren("/za-investmentlink",true));
//        System.out.println(str);
    }
}
